...
```
From the plot of 24-hour activity time courses for each category level, we can learn that there is no significant difference of 24-hour activity time courses between all three education categories. 